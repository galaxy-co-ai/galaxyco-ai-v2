...
export const SCHEDULE_PRESETS: SchedulePreset[] = [
  { label: 'Every hour', value: 'hourly', cron: '0 * * * *', description: 'Runs at the top of every hour' },
  { label: 'Every 6 hours', value: '6hours', cron: '0 */6 * * *', description: 'Runs 4 times daily' },
  { label: 'Daily at 9 AM', value: 'daily-9am', cron: '0 9 * * *', description: 'Runs once daily' },
  { label: 'Weekdays at 9 AM', value: 'weekdays-9am', cron: '0 9 * * 1-5', description: 'Runs Mon-Fri' },
  { label: 'Weekly on Monday', value: 'weekly-mon', cron: '0 9 * * 1', description: 'Runs every Monday' },
