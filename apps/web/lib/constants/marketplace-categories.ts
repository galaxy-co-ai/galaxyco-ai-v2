...
export const MARKETPLACE_CATEGORIES: MarketplaceCategory[] = [
  {
    ...
    heroSubtitle: 'Automate workflows, manage tasks, and coordinate tools seamlessly',
  },
  {
    id: 'analytics',
    name: 'Data & Analytics',
  ...
  },
  {
    ...
    heroSubtitle: 'Intelligent document retrieval, research, and knowledge synthesis',
  },
  {
    id: 'hr',
    ...
    heroSubtitle: 'Recruiting, onboarding, compliance, and performance management',
  },
  {
    id: 'engineering',
    ...
    heroSubtitle: 'API connectors, automation sandbox, and prompt-to-pipeline tools',
  },
];
