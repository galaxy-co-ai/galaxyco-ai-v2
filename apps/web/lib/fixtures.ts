    ...
    researchInsights: [
      {
        ...
        content: 'TechStartup Inc raised $15M in Series A funding to expand their engineering team and accelerate product development.',
        source: 'TechCrunch',
      ...
      },
      {
        ...
        content: 'Sarah Chen spent 4+ years at Google working on backend systems for high-scale products like Gmail and Google Drive.',
        source: 'LinkedIn',
        confidenceScore: 98,
        relevanceScore: 88,
        createdAt: new Date(Date.now() - 60 * 60 * 1000).toISOString(),
...
export const generateMockProspects = (count: number): Prospect[] => {
  const companies = [
    'TechCorp', 'InnovateX', 'ScaleUp', 'GrowthFlow', 'DataDriven',
    'CloudFirst', 'AILabs', 'FutureWork', 'SmartBiz', 'NextGen'
  ]
  
  const titles = [
    'CEO', 'CTO', 'VP Engineering', 'Head of Sales', 'Director of Marketing',
    'VP Product', 'Chief Data Officer', 'Head of Growth', 'VP Operations'
  ]
  
  const statuses: Prospect['status'][] = [
    'new', 'enriched', 'email_sent', 'replied', 'qualified', 'lost'
  ]
