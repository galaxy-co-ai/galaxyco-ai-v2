...
## 🔐 Modern Nango Authentication Flow
...
| --------------------------- | --------------------------------------- |
| Public key in frontend      | ❌ Removed                              |
| Manual connection IDs       | ✅ Auto-generated by Nango              |
| Connection ID from frontend | ✅ Returned via backend webhook         |
| `new Nango({ publicKey })`  | ✅ `new Nango({ connectSessionToken })` |
...
## 🚀 Migration from Public Key (If Needed)
