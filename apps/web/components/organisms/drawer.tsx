...
export const Drawer: React.FC<DrawerProps> = ({
  ...
  return (
    ...
    >
      <SheetContent side={side} className={cn(sizeClasses, 'flex flex-col p-0', className)}>
        {/* Header */}
        ...
        {/* Footer */}
        {footer && <SheetFooter className="border-t border-border p-6 pt-4">{footer}</SheetFooter>}
      </SheetContent>
    </Sheet>
  );
};
