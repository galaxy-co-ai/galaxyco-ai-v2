...
export function TemplateLibrary({
  ...
  const filteredTemplates = useMemo(() => {
    ...
    if (searchQuery.trim() && selectedCategory !== 'all') {
      templates = searchTemplates(searchQuery).filter((t) => t.category === selectedCategory);
    }
        ...
        >
          <button
            ...
            style={{
              ...
              cursor: 'pointer',
              background: selectedCategory === 'all' ? colors.primary[500] : colors.neutral[100],
              color: selectedCategory === 'all' ? colors.neutral[0] : colors.neutral[700],
          ...
          {TEMPLATE_CATEGORIES.map((category) => (
            <button
              ...
              style={{
                ...
                cursor: 'pointer',
                background:
                  selectedCategory === category.id ? colors.primary[500] : colors.neutral[100],
                color: selectedCategory === category.id ? colors.neutral[0] : colors.neutral[700],
                transition: `all ${animation.timing.fast}`,
                whiteSpace: 'nowrap',
              }}
            >
