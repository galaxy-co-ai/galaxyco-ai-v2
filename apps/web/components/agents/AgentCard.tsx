    ...
    <Card hover={true} onClick={() => onView?.(agent)}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: spacing.lg }}>
              ...
              {agent.status && (
                <span
                  style={{
                    ...
                    color: agent.status === 'active' ? colors.success : colors.neutral[600],
          ...
          >
            {agent.stats.successRate !== undefined && (
              <div>
                ...
                <div style={{ fontSize: typography.fontSize.base, fontWeight: typography.fontWeight.semibold, color: colors.success }}>
        ...
        {agent.integrations && agent.integrations.length > 0 && (
          <div>
            <div style={{ fontSize: typography.fontSize.xs, color: colors.neutral[500], marginBottom: spacing.sm }}>
              Integrations
            </div>
