...
const STARTER_PACKS = [
  {
    ...
    description:
      'Everything you need to run your startup efficiently. Automate browser tasks, capture meeting notes, and orchestrate cross-app workflows.',
  ...
  },
  {
    ...
    name: 'Sales GTM Pack',
    description:
      'Accelerate your go-to-market motion. Prospect smarter, personalize outreach, and keep your CRM up-to-date automatically.',
    category: 'Sales',
    agentCount: 4,
    agentNames: [
      'Sales GTM Copilot',
  ...
  },
  {
    ...
    description:
      'Build your AI-powered knowledge base. Get instant answers with citations, summarize research, and create content from your sources.',
    category: 'Knowledge',
    agentCount: 3,
    agentNames: ['Knowledge RAG Agent', 'Research & Web Summary Agent', 'Content Generation Agent'],
    badgeText: 'NEW',
  ...
  },
  {
    ...
    description:
      'Get more done with less effort. Orchestrate tasks across apps, automate meeting follow-ups, and manage your daily workflow.',
    category: 'Productivity',
    agentCount: 4,
    agentNames: [
      'Cross-App Do-It-For-Me',
  ...
  },
  {
    ...
    description:
      'Ensure security and compliance across your AI operations. Check agents, extract data safely, and maintain audit trails.',
    category: 'Security',
    agentCount: 3,
    agentNames: ['Trust & Security Checker', 'Data Extraction Agent', 'Audit & Compliance Agent'],
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Pre-configured agent teams for instant productivity. Install a pack to get multiple agents
          working together.
        </p>
