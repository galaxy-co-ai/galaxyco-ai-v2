...
export default function MarketplacePacks({
  onInstallPack,
  onPreviewPack,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Pre-configured agent teams for instant productivity. Install a pack to
            ...
            {(["popular", "newest", "rating"] as const).map((option) => (
              <button
                ...
                style={{
                  padding: "0.5rem 1rem",
                  background:
                    sortBy === option ? colors.primary[500] : "transparent",
      ...
      >
        ...
        >
          Browse individual agents or create your own custom pack with the Agent
          Builder
        </p>
        <div
          style={{
