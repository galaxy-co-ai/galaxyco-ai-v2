...
describe('Textarea', () => {
  ...
  it('renders with different sizes', () => {
    const { container: containerSm } = render(React.createElement(Textarea, { size: 'sm' }));
    const { container: containerLg } = render(React.createElement(Textarea, { size: 'lg' }));
  ...
  it('renders with destructive variant', () => {
    const { container } = render(React.createElement(Textarea, { variant: 'destructive' }));
    const textarea = container.querySelector('textarea');
  ...
  it('can be read-only', () => {
    render(React.createElement(Textarea, { readOnly: true, value: 'Read only' }));
  ...
  it('applies custom className', () => {
    const { container } = render(React.createElement(Textarea, { className: 'custom-class' }));
    const textarea = container.querySelector('textarea');
  ...
  it('applies resize-none class when autoResize is true', () => {
    const { container } = render(React.createElement(Textarea, { autoResize: true }));
    const textarea = container.querySelector('textarea');
