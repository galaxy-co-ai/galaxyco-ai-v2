...
describe('Code', () => {
  it('renders inline code by default', () => {
    const { container } = render(React.createElement(Code, null, 'npm install'));
  ...
  it('renders block code with pre tag', () => {
    const { container } = render(React.createElement(Code, { variant: 'block' }, 'const x = 1;'));
  ...
  it('applies language attribute for block code', () => {
    const { container } = render(
      React.createElement(Code, { variant: 'block', language: 'typescript' }, 'const x = 1;'),
    );
    const code = container.querySelector('code');
  ...
  it('applies custom className to inline code', () => {
    const { container } = render(
      React.createElement(Code, { variant: 'inline', className: 'custom-code' }, 'test'),
    );
    const code = container.querySelector('code');
  ...
  it('applies custom className to block code', () => {
    const { container } = render(
      React.createElement(Code, { variant: 'block', className: 'custom-block' }, 'test'),
    );
    const pre = container.querySelector('pre');
  ...
  it('inline variant has border', () => {
    const { container } = render(React.createElement(Code, { variant: 'inline' }, 'test'));
    const code = container.querySelector('code');
    expect(code).toHaveClass('border');
  });

  it('block variant has overflow-x-auto', () => {
    const { container } = render(React.createElement(Code, { variant: 'block' }, 'test'));
    const pre = container.querySelector('pre');
