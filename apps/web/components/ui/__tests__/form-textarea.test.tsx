...
describe('FormTextarea', () => {
  ...
  it('applies error styling', () => {
    const { container } = render(React.createElement(FormTextarea, { error: 'Error' }));
  ...
  it('helperText takes precedence over helper', () => {
    render(React.createElement(FormTextarea, { helper: 'Old', helperText: 'New' }));
  ...
  it('supports placeholder', () => {
    const { container } = render(React.createElement(FormTextarea, { placeholder: 'Enter text' }));
    const textarea = container.querySelector('textarea');
