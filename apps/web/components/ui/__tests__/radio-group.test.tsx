...
describe('RadioGroup', () => {
  ...
  it('selects default value', () => {
    const { container } = render(React.createElement(BasicRadioGroup));
    const firstItem = container.querySelector("button[value='option1']") as HTMLElement;
  ...
  it('handles value change', async () => {
    ...
    const secondItem = container.querySelector("button[value='option2']") as HTMLElement;
