...
describe("Avatar", () => {
  ...
  it("renders with fallback text", async () => {
    const { container } = render(
      React.createElement(Avatar, { fallback: "JD" }),
    );
  ...
  it("renders with square variant", () => {
    const { container } = render(
      React.createElement(Avatar, { variant: "square" }),
    );
    const avatar = container.firstChild as HTMLElement;
  ...
  it("renders with offline status", () => {
    const { container } = render(
      React.createElement(Avatar, { status: "offline" }),
    );
  ...
  it("renders with busy status", () => {
    const { container } = render(
      React.createElement(Avatar, { status: "busy" }),
    );
  ...
  it("renders with away status", () => {
    const { container } = render(
      React.createElement(Avatar, { status: "away" }),
    );
  ...
  it("applies custom className", () => {
    const { container } = render(
      React.createElement(Avatar, { className: "custom-avatar" }),
    );
    const avatar = container.firstChild as HTMLElement;
  ...
  it("renders status dot with correct size for avatar size", () => {
    const { container } = render(
      React.createElement(Avatar, { size: "lg", status: "online" }),
    );
    const statusDot = container.querySelector("span[aria-label='online']");
