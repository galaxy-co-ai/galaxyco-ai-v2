...
describe('FormInput', () => {
  ...
  it('renders left icon', () => {
    const icon = React.createElement('div', { className: 'left-test-icon' }, 'Icon');
    const { container } = render(React.createElement(FormInput, { leftIcon: icon }));
    expect(container.querySelector('.left-test-icon')).toBeInTheDocument();
  });

  it('renders right icon', () => {
    const icon = React.createElement('div', { className: 'right-test-icon' }, 'Icon');
    const { container } = render(React.createElement(FormInput, { rightIcon: icon }));
  ...
  it('applies error styling to input', () => {
    const { container } = render(React.createElement(FormInput, { error: 'Error' }));
    const input = container.querySelector('input');
  ...
  it('helperText takes precedence over helper', () => {
    render(React.createElement(FormInput, { helper: 'Old', helperText: 'New' }));
