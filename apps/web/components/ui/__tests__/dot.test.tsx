...
describe("Dot", () => {
  ...
  it("renders with different sizes", () => {
    ...
    const { container: cDefault } = render(
      React.createElement(Dot, { size: "default" }),
    );
  ...
  it("has aria-label when label is provided", () => {
    const { container } = render(
      React.createElement(Dot, { label: "Important" }),
    );
  ...
  it("applies custom className", () => {
    const { container } = render(
      React.createElement(Dot, { className: "custom-dot" }),
    );
