...
describe('Badge', () => {
  ...
  it('renders with primary variant', () => {
    const { container } = render(React.createElement(Badge, { variant: 'primary' }, 'Primary'));
    const badge = container.querySelector('div');
  ...
  it('renders with success variant', () => {
    const { container } = render(React.createElement(Badge, { variant: 'success' }, 'Success'));
    const badge = container.querySelector('div');
  ...
  it('renders with destructive variant', () => {
    const { container } = render(React.createElement(Badge, { variant: 'destructive' }, 'Error'));
    const badge = container.querySelector('div');
  ...
  it('renders with solid variants', () => {
    const { container } = render(React.createElement(Badge, { variant: 'primary-solid' }, 'Solid'));
    const badge = container.querySelector('div');
  ...
  it('renders with different sizes', () => {
    const { container: containerSm } = render(React.createElement(Badge, { size: 'sm' }, 'Small'));
    const { container: containerLg } = render(React.createElement(Badge, { size: 'lg' }, 'Large'));
  ...
  it('renders as removable with close button', () => {
    ...
    render(React.createElement(Badge, { removable: true, onRemove }, 'Removable Badge'));
