...
describe("Switch", () => {
  ...
  it("toggles when clicked", async () => {
    ...
    const { container } = render(
      React.createElement(Switch, { onCheckedChange }),
    );
  ...
  it("renders with different sizes", () => {
    const { container: containerSm } = render(
      React.createElement(Switch, { size: "sm" }),
    );
    const { container: containerLg } = render(
      React.createElement(Switch, { size: "lg" }),
    );
  ...
  it("applies custom className", () => {
    const { container } = render(
      React.createElement(Switch, { className: "custom-class" }),
    );
    const switchButton = container.querySelector("button");
