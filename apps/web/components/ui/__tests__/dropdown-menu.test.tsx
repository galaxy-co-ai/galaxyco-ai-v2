...
describe('DropdownMenu', () => {
    ...
    const { container } = render(
      React.createElement(
        ...
        React.createElement(
          DropdownMenuContent,
          null,
          React.createElement(DropdownMenuCheckboxItem, { checked: true }, 'Show Sidebar'),
        ),
      ),
    );
    const item = screen.getByText('Show Sidebar');
    expect(item).toBeInTheDocument();
    expect(item.closest('[role="menuitemcheckbox"]')).toHaveAttribute('data-state', 'checked');
  });
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            DropdownMenuRadioGroup,
            { value: 'option1' },
            React.createElement(DropdownMenuRadioItem, { value: 'option1' }, 'Option 1'),
            React.createElement(DropdownMenuRadioItem, { value: 'option2' }, 'Option 2'),
          ),
        ),
      ),
    );
    ...
    const { container } = render(
      React.createElement(
        ...
        React.createElement(
          DropdownMenuContent,
          null,
          React.createElement(DropdownMenuCheckboxItem, { checked: true }, 'Checked'),
        ),
      ),
    );
  ...
  it('radio item has circle indicator when selected', () => {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            DropdownMenuRadioGroup,
            { value: 'option1' },
            React.createElement(DropdownMenuRadioItem, { value: 'option1' }, 'Selected'),
          ),
        ),
      ),
    );
    ...
    expect(item.closest('[role="menuitemradio"]')).toHaveAttribute('data-state', 'checked');
  });
  ...
  it('shortcut has opacity styling', () => {
    const { container } = render(React.createElement(DropdownMenuShortcut, null, '⌘K'));
