...
describe('Dialog', () => {
  ...
  it('renders close button in content', () => {
    const { container } = render(
      React.createElement(
        ...
        { open: true },
        React.createElement(DialogTrigger, null, 'Open'),
        React.createElement(DialogContent, null, React.createElement(DialogTitle, null, 'Dialog')),
      ),
    );
  ...
  it('header has flex col layout', () => {
    const { container } = render(
      React.createElement(DialogHeader, null, React.createElement('div', null, 'Header content')),
    );
  ...
  it('footer has border top', () => {
    const { container } = render(
      React.createElement(DialogFooter, null, React.createElement('div', null, 'Footer content')),
    );
  ...
  it('forwards ref to content', () => {
    ...
    render(
      React.createElement(
        Dialog,
        { open: true },
        React.createElement(DialogContent, { ref }, React.createElement(DialogTitle, null, 'Test')),
      ),
    );
