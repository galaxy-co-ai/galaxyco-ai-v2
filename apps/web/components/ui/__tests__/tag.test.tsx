...
describe("Tag", () => {
  ...
  it("renders with different sizes", () => {
    const { container: cSm } = render(
      React.createElement(Tag, { size: "sm" }, "Small"),
    );
    const { container: cDefault } = render(
      React.createElement(Tag, { size: "default" }, "Default"),
    );
    const { container: cLg } = render(
      React.createElement(Tag, { size: "lg" }, "Large"),
    );
  ...
  it("renders remove button when removable", () => {
    const { container } = render(
      React.createElement(Tag, { removable: true }, "Removable"),
    );
  ...
  it("does not render remove button when not removable", () => {
    const { container } = render(
      React.createElement(Tag, { removable: false }, "Tag"),
    );
    const button = container.querySelector("button");
  ...
  it("applies custom className", () => {
    const { container } = render(
      React.createElement(Tag, { className: "custom-tag" }, "Custom"),
    );
