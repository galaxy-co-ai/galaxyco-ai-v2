...
describe("Heading", () => {
  it("renders h2 by default", () => {
    const { container } = render(
      React.createElement(Heading, null, "Test Heading"),
    );
  ...
  it("renders different heading levels", () => {
    const { container: c1 } = render(
      React.createElement(Heading, { level: 1 }, "H1"),
    );
    const { container: c3 } = render(
      React.createElement(Heading, { level: 3 }, "H3"),
    );
    const { container: c6 } = render(
      React.createElement(Heading, { level: 6 }, "H6"),
    );
  ...
  it("renders different sizes", () => {
    const { container: cXs } = render(
      React.createElement(Heading, { size: "xs" }, "XS"),
    );
    const { container: cSm } = render(
      React.createElement(Heading, { size: "sm" }, "SM"),
    );
    const { container: c2xl } = render(
      React.createElement(Heading, { size: "2xl" }, "2XL"),
    );
    const { container: c5xl } = render(
      React.createElement(Heading, { size: "5xl" }, "5XL"),
    );
  ...
  it("renders different weights", () => {
    ...
    const { container: cBold } = render(
      React.createElement(Heading, { weight: "bold" }, "Bold"),
    );
  ...
  it("uses 'as' prop to override element", () => {
    const { container } = render(
      React.createElement(Heading, { level: 3, as: "h1" }, "Visual H1"),
    );
