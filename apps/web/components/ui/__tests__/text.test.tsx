...
describe("Text", () => {
  ...
  it("renders different elements with 'as' prop", () => {
    const { container: cSpan } = render(
      React.createElement(Text, { as: "span" }, "Span"),
    );
    const { container: cDiv } = render(
      React.createElement(Text, { as: "div" }, "Div"),
    );
    const { container: cLabel } = render(
      React.createElement(Text, { as: "label" }, "Label"),
    );
  ...
  it("renders different variants", () => {
    const { container: cBody } = render(
      React.createElement(Text, { variant: "body" }, "Body"),
    );
    const { container: cMuted } = render(
      React.createElement(Text, { variant: "muted" }, "Muted"),
    );
    ...
    const { container: cError } = render(
      React.createElement(Text, { variant: "error" }, "Error"),
    );
  ...
  it("renders different sizes", () => {
    const { container: cXs } = render(
      React.createElement(Text, { size: "xs" }, "XS"),
    );
    const { container: cSm } = render(
      React.createElement(Text, { size: "sm" }, "SM"),
    );
    const { container: cBase } = render(
      React.createElement(Text, { size: "base" }, "Base"),
    );
    const { container: cLg } = render(
      React.createElement(Text, { size: "lg" }, "LG"),
    );
  ...
  it("renders different weights", () => {
    ...
    const { container: cBold } = render(
      React.createElement(Text, { weight: "bold" }, "Bold"),
    );
  ...
  it("applies custom className", () => {
    const { container } = render(
      React.createElement(Text, { className: "custom-text" }, "Custom"),
    );
