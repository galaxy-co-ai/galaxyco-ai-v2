...
describe('Card', () => {
  ...
  it('renders with interactive variant', () => {
    const { container } = render(React.createElement(Card, { interactive: true }));
    const card = container.querySelector('div');
  ...
  it('renders with outline variant', () => {
    const { container } = render(React.createElement(Card, { variant: 'outline' }));
    const card = container.querySelector('div');
    expect(card).toHaveClass('bg-background');
  });

  it('renders with ghost variant', () => {
    const { container } = render(React.createElement(Card, { variant: 'ghost' }));
    const card = container.querySelector('div');
  ...
  it('renders with different padding sizes', () => {
    const { container: containerNone } = render(React.createElement(Card, { padding: 'none' }));
    const { container: containerSm } = render(React.createElement(Card, { padding: 'sm' }));
    const { container: containerLg } = render(React.createElement(Card, { padding: 'lg' }));
