...
describe("Logo", () => {
  ...
  it("renders icon-only variant", () => {
    const { container } = render(
      React.createElement(Logo, { variant: "icon-only" }),
    );
    expect(container.querySelector("svg")).toBeInTheDocument();
  });
  ...
  it("renders wordmark variant", () => {
    const { container } = render(
      React.createElement(Logo, { variant: "wordmark" }),
    );
  ...
  it("renders full variant", () => {
    const { container } = render(
      React.createElement(Logo, { variant: "full" }),
    );
    const svg = container.querySelector("svg");
    expect(svg).toBeInTheDocument();
  });
  ...
  it("renders with different sizes", () => {
    ...
    const { container: cLg } = render(
      React.createElement(Logo, { size: "lg" }),
    );
    const { container: cXl } = render(
      React.createElement(Logo, { size: "xl" }),
    );
  ...
  it("applies custom className", () => {
    const { container } = render(
      React.createElement(Logo, { className: "custom-logo" }),
    );
