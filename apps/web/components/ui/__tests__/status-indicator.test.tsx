...
describe('StatusIndicator', () => {
  it('renders status indicator', () => {
    const { container } = render(React.createElement(StatusIndicator, { status: 'online' }));
  ...
  it('renders with different status variants', () => {
    ...
    const { container: cBusy } = render(React.createElement(StatusIndicator, { status: 'busy' }));
    const { container: cAway } = render(React.createElement(StatusIndicator, { status: 'away' }));
  ...
  it('has correct aria-label', () => {
    const { container } = render(React.createElement(StatusIndicator, { status: 'busy' }));
    const indicator = container.querySelector('[role="status"]');
