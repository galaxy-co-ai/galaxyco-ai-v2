...
describe("Checkbox", () => {
  ...
  it("toggles when clicked", async () => {
    ...
    const { container } = render(
      React.createElement(Checkbox, { onCheckedChange }),
    );
  ...
  it("renders with different sizes", () => {
    const { container: containerSm } = render(
      React.createElement(Checkbox, { size: "sm" }),
    );
    const { container: containerLg } = render(
      React.createElement(Checkbox, { size: "lg" }),
    );
  ...
  it("renders with destructive variant", () => {
    const { container } = render(
      React.createElement(Checkbox, { variant: "destructive" }),
    );
    const checkbox = container.querySelector("button");
  ...
  it("applies custom className", () => {
    const { container } = render(
      React.createElement(Checkbox, { className: "custom-class" }),
    );
    const checkbox = container.querySelector("button");
  ...
  it("has proper accessibility attributes", () => {
    const { container } = render(
      React.createElement(Checkbox, { "aria-label": "Accept terms" }),
    );
    const checkbox = container.querySelector("button");
