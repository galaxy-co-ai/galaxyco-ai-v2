...
describe('FormField', () => {
  ...
  it('renders with input by default', () => {
    const { container } = render(React.createElement(FormField, { label: 'Email', type: 'email' }));
  ...
  it('applies disabled state to input', () => {
    const { container } = render(React.createElement(FormField, { label: 'Name', disabled: true }));
    const input = container.querySelector('input');
    expect(input).toBeDisabled();
  });

  it('applies readonly state to input', () => {
    const { container } = render(React.createElement(FormField, { label: 'ID', readOnly: true }));
    const input = container.querySelector('input');
  ...
  it('calls onChange when input value changes', async () => {
    ...
    const { container } = render(React.createElement(FormField, { label: 'Name', onChange }));
  ...
  it('error message has role alert', () => {
    render(React.createElement(FormField, { label: 'Email', error: 'Error text' }));
  ...
  it('renders different input types', () => {
    ...
    expect(cPassword.querySelector('input[type="password"]')).toBeInTheDocument();
