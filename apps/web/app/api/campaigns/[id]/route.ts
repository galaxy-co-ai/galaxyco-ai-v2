...
import { updateCampaignSchema } from '@/lib/validation/business';
...
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    logger.error('Fetch campaign error', {
...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    const validation = safeValidateRequest(updateCampaignSchema, body);
    ...
    logger.info('Campaigns updated successfully', {
      userId: user.id,
      workspaceId,
      campaignId,
      durationMs,
...
export async function DELETE(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    const durationMs = Date.now() - startTime;
    logger.info('Campaigns deleted successfully', {
      userId: user.id,
      workspaceId,
      campaignId,
      durationMs,
