...
import { updateCalendarEventSchema } from "@/lib/validation/crm";
...
export async function GET(
  ...
  try {
    ...
    logger.error("Fetch event error", {
...
export async function PUT(
  ...
  try {
    ...
    const validation = safeValidateRequest(updateCalendarEventSchema, body);
