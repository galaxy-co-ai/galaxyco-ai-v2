...
import { updateInboxMessageSchema } from '@/lib/validation/communication';
...
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    logger.error('Fetch message error', {
...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    const validation = safeValidateRequest(updateInboxMessageSchema, body);
    ...
    logger.info('Inbox updated successfully', {
      userId: user.id,
      workspaceId,
      messageId,
      durationMs,
...
export async function DELETE(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    const durationMs = Date.now() - startTime;
    logger.info('Inbox deleted successfully', {
      userId: user.id,
      workspaceId,
      messageId,
      durationMs,
