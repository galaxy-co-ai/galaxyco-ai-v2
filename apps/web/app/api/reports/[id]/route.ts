...
import { updateReportSchema } from "@/lib/validation/analytics";
...
export async function GET(
  ...
  try {
    ...
    logger.error("Fetch report error", {
...
export async function PUT(
  ...
  try {
    ...
    const validation = safeValidateRequest(updateReportSchema, body);
