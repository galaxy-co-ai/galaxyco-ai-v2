...
import { updateEmailSchema } from '@/lib/validation/communication';
...
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    logger.error('Fetch email error', {
...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    const rateLimitResult = await checkRateLimit(clerkUserId, RATE_LIMITS.EMAIL_SEND);
    ...
    const validation = safeValidateRequest(updateEmailSchema, body);
