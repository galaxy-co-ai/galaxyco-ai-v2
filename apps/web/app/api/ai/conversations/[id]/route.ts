...
export async function GET(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const conversationContext = await conversationService.getConversation(id, workspaceId);
...
export async function DELETE(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const success = await conversationService.deleteConversation(id, workspaceId);
