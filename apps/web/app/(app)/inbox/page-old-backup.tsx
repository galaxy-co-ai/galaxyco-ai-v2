...
import { MessageSquare, Send, Search, Star, Plus, MoreHorizontal } from 'lucide-react';
    ...
    messages: [
      {
        ...
        content: "Hey! I've updated the sales playbook with the new pricing guidelines.",
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 overflow-hidden">
          <div className="flex items-center justify-between">
            <h4 className="font-semibold text-foreground">{conversation.participants[0].name}</h4>
...
function MessageBubble({ message }: { message: Message }) {
  return (
    <div className={`flex gap-3 ${message.sender.isCurrentUser ? 'flex-row-reverse' : ''}`}>
      <Avatar
        ...
        size="sm"
      />
      <div className={`flex-1 ${message.sender.isCurrentUser ? 'flex justify-end' : ''}`}>
        <div
            ...
            <Card className="flex h-[700px] flex-col">
              ...
              <div className="flex items-center justify-between border-b border-border p-4">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <h3 className="font-semibold">{selectedConversation.participants[0].name}</h3>
