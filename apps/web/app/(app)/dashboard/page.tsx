...
function MainChart({ selectedCategory }: { selectedCategory: string | null }) {
  const chartData = categoryChartData[selectedCategory || 'user-time'] || categoryChartData['user-time']
  const chartConfig = categoryChartConfig[selectedCategory || 'user-time'] || categoryChartConfig['user-time']
          ...
          <LineChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
            ...
            {chartConfig.lines.map((line: any, index: number) => (
              <Line 
                ...
                activeDot={{ r: 6, stroke: line.stroke, strokeWidth: 2, fill: 'white' }}
              />
            ))}
          </LineChart>
        </ResponsiveContainer>
