...
import { Shield, Key, Smartphone, Monitor, CheckCircle2, XCircle } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        <Card className="p-6">
          <div className="mb-4">
            <h3 className="mb-2 text-lg font-semibold">Security Notifications</h3>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="space-y-4 border-t border-border pt-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">recovery@example.com</p>
              </div>
              <Button variant="outline" size="sm">
                Update
              </Button>
