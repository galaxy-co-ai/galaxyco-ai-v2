...
import { Check, AlertCircle, Info, ChevronRight, ChevronLeft, X } from 'lucide-react';
...
const industries = ['Technology', 'Finance', 'Healthcare', 'E-commerce', 'Manufacturing', 'Other'];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-background-elevated border border-border rounded-lg p-6 sm:p-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-semibold text-foreground">{steps[currentStep].label}</h2>
              <p className="text-sm text-foreground-muted mt-1">{steps[currentStep].description}</p>
            </div>
            {autoSaved && (
              ...
              <div>
                ...
                <select
                  ...
                  className={cn(
                    'w-full px-4 py-2.5 rounded-lg border bg-background-subtle transition-colors',
                    'focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary',
                    errors.industry ? 'border-destructive focus:ring-destructive' : 'border-border',
                  )}
                >
              ...
              <div>
                ...
                <select
                  ...
                  className={cn(
                    'w-full px-4 py-2.5 rounded-lg border bg-background-subtle transition-colors',
                    'focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary',
                    errors.teamSize ? 'border-destructive focus:ring-destructive' : 'border-border',
                  )}
                >
              ...
              <div>
                ...
                <select
                  ...
                  className={cn(
                    'w-full px-4 py-2.5 rounded-lg border bg-background-subtle transition-colors',
                    'focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary',
                    errors.role ? 'border-destructive focus:ring-destructive' : 'border-border',
                  )}
                >
              ...
              <div className="p-4 rounded-lg bg-primary/10 border border-primary/20">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-foreground">
                    <strong className="font-medium">Pro Tip:</strong> We use this information to
                    customize your workspace and recommend relevant features. You can change these
                    settings anytime.
                  </div>
                </div>
              </div>
          ...
          {currentStep === 3 && (
            <div className="text-center py-8">
              ...
              <p className="text-foreground-muted mb-8">
                Your workspace is ready. Let&apos;s start building with AI agents.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
                <div className="p-4 rounded-lg border border-border bg-background-subtle">
                  <div className="font-semibold text-foreground mb-1">Company</div>
                  <div className="text-sm text-foreground-muted">{formData.companyName}</div>
                </div>
                <div className="p-4 rounded-lg border border-border bg-background-subtle">
                  <div className="font-semibold text-foreground mb-1">Industry</div>
                  <div className="text-sm text-foreground-muted">{formData.industry}</div>
                </div>
                <div className="p-4 rounded-lg border border-border bg-background-subtle">
                  <div className="font-semibold text-foreground mb-1">Primary Goal</div>
                  <div className="text-sm text-foreground-muted">{formData.primaryGoal}</div>
                </div>
              </div>
            </div>
          )}
