...
export default function ResourcesPage() {
  ...
  const { data, error, isLoading } = useSWR<ResourcesResponse>(
    currentWorkspace ? `/api/resources?workspaceId=${currentWorkspace.id}&limit=100` : null,
    fetcher,
    {
    ...
    return (
      <div className="flex h-full items-center justify-center">
        <div className="text-center">
          <p className="text-red-600 dark:text-red-400 mb-2">Failed to load resources</p>
