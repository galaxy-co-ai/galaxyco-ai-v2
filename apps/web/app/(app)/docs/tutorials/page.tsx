...
import { Play, Clock, BookOpen, Award, Search, Filter, ChevronRight } from 'lucide-react';
...
const tutorials = [
  ...
  },
  {
    ...
    description: 'Step-by-step guide to creating and deploying your first agent',
    duration: '22 min',
    level: 'Beginner',
  ...
  },
  {
    ...
    description: 'Connect GalaxyCo.ai with Salesforce CRM for seamless data sync',
    duration: '18 min',
    level: 'Intermediate',
  ...
  return (
    <div className="p-6 md:p-8">
      ...
      <Card className="p-8 mb-8 bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
        ...
        <h2 className="text-2xl font-semibold mb-3">Complete GalaxyCo.ai Masterclass</h2>
        <p className="text-foreground-muted mb-6 max-w-2xl">
          Everything you need to become an expert in AI automation. From basic concepts to advanced
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground-muted">{path.description}</p>
