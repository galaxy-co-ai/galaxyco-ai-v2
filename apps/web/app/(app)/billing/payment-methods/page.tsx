  ...
  return (
    ...
    >
      <div className="space-y-4">
        {methods.map((method) => (
          <div key={method.id} className="rounded-lg border bg-card p-6 flex items-start gap-4">
      ...
      <div className="mt-6 rounded-lg border border-yellow-200 bg-yellow-50 dark:border-yellow-800 dark:bg-yellow-950 p-4">
        ...
        <p className="text-sm text-muted-foreground">
          All payment information is encrypted and securely stored. We never see or store your full
          credit card number.
        </p>
      </div>
    </PageShell>
