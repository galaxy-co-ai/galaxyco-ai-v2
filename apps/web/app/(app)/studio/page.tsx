...
import { VisualGridBuilder } from '@/components/galaxy/VisualGridBuilder';
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm">
                        Hi! I&apos;m your AI assistant. Tell me what kind of agent you&apos;d like
                        to create, and I&apos;ll help you build it step by step. I can help with:
                      </p>
