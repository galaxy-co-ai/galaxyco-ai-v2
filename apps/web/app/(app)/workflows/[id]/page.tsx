      ...
      <Card className="p-6">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <p className="mb-4 text-sm text-muted-foreground">{workflowData.description}</p>
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              ...
              <div>Created {new Date(workflowData.created).toLocaleDateString()}</div>
            </div>
          </div>
            ...
            <tbody>
              {workflowData.executions.map((execution) => (
                <tr key={execution.id} className="border-b border-border">
                  ...
                  <td className="py-3 text-sm">{new Date(execution.startedAt).toLocaleString()}</td>
