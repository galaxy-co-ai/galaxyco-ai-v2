            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center min-w-[48px] h-16 rounded-lg transition-colors touch-manipulation ${
                  isToday ? 'bg-primary text-primary-foreground' : 'hover:bg-background-subtle'
                }`}
              ...
              >
                ...
                <span className="text-lg font-semibold mt-1">{date.getDate()}</span>
              </button>
            );
          })}
        </div>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-foreground-muted">· {event.duration}</span>
                </div>
              ...
              {event.location && (
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-foreground-muted">{event.location}</span>
                </div>
              )}
