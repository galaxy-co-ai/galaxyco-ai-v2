...
import { ChevronRight, Plus, Play, Pause, Settings, TrendingUp, Clock } from 'lucide-react';
          ...
          >
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-muted-foreground truncate">{workflow.trigger}</p>
              </div>
            ...
            <div className="grid grid-cols-3 gap-2 mb-3">
              <div className="text-center p-2 rounded bg-background-subtle">
                ...
                <p className="text-sm font-semibold">{workflow.executions.toLocaleString()}</p>
              </div>
              <div className="text-center p-2 rounded bg-background-subtle">
              ...
              <div className="text-center p-2 rounded bg-background-subtle">
                ...
                <p className="text-xs font-semibold truncate">{workflow.lastRun}</p>
              </div>
            </div>
