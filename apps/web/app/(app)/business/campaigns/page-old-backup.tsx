    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-4 mb-6">
        ...
        <div className="rounded-lg border border-border bg-card p-4">
          ...
          <p className="text-2xl font-bold">
            {campaigns.length > 0
              ? (
                  (totalConversions / campaigns.reduce((sum, c) => sum + (c.sent || c.clicks), 0)) *
                  100
                ).toFixed(1)
              : 0}
            %
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {filteredCampaigns.map((campaign) => {
          ...
          const openRate = campaign.sent ? ((campaign.opens / campaign.sent) * 100).toFixed(1) : 0;
            ...
            >
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-semibold text-primary">{campaign.conversions}</span>
                </div>
                {campaign.budget && (
