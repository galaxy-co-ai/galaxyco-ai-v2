  ...
  useEffect(() => {
    async function fetchAnalytics() {
      ...
      try {
        ...
        const [salesRes, marketingRes, outreachRes, usageRes] =
          await Promise.all([
        ...
        const [salesData, marketingData, outreachData, usageData] =
          await Promise.all([
            salesRes.json(),
            marketingRes.json(),
            outreachRes.json(),
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="p-6">
          ...
          <p className="text-2xl font-bold">
            {analytics.marketing.prospects.total}
          </p>
        ...
        <Card className="p-6">
          ...
          <p className="text-2xl font-bold">
            {analytics.outreach.contacts.total}
          </p>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Link href="/analytics/sales">
          <Card className="p-6 transition-colors hover:bg-accent">
            ...
            <p className="text-sm text-muted-foreground">
              Revenue, invoices, and customer metrics
            </p>
          </Card>
        </Link>
        ...
        <Link href="/analytics/outreach">
          <Card className="p-6 transition-colors hover:bg-accent">
            ...
            <p className="text-sm text-muted-foreground">
              Tasks, events, and contact engagement
            </p>
          </Card>
        </Link>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Card className="p-6">
          ...
          <p className="text-3xl font-bold">
            {analytics.sales.customers.total}
          </p>
        </Card>
        <Card className="p-6">
