...
const folders: KBFolder[] = [
  ...
  { id: '5', name: 'Client Resources', documentCount: 31, color: 'pink' },
...
const recentActivity = [
  {
    action: 'uploaded',
    user: 'AI Assistant',
    document: 'TechCorp Implementation Plan.pdf',
    time: '2 hours ago',
  },
  {
    action: 'viewed',
  ...
  },
  {
    ...
    document: 'Client Onboarding Checklist.xlsx',
    time: '5 hours ago',
  },
  {
    action: 'uploaded',
    user: 'Emma Thompson',
    document: 'Brand Guidelines 2025.pdf',
    time: '1 day ago',
  },
];
...
export default function KnowledgeBasePage() {
  ...
  const getFileColor = (type: KBDocument['type']) => {
    switch (type) {
      case 'pdf':
        return 'from-red-500/10 to-red-500/20 text-red-500';
      case 'document':
        return 'from-blue-500/10 to-blue-500/20 text-blue-500';
      case 'image':
        return 'from-green-500/10 to-green-500/20 text-green-500';
      case 'video':
        return 'from-purple-500/10 to-purple-500/20 text-purple-500';
      case 'spreadsheet':
        return 'from-emerald-500/10 to-emerald-500/20 text-emerald-500';
      case 'presentation':
        return 'from-orange-500/10 to-orange-500/20 text-orange-500';
      default:
        return 'from-gray-500/10 to-gray-500/20 text-gray-500';
    }
  };
              ...
              {folders.map((folder) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`h-8 w-8 rounded-lg bg-gradient-to-br from-${folder.color}-500/10 to-${folder.color}-500/20 flex items-center justify-center`}
                    >
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="outline"
                      size="sm"
                      className="shadow-[0_2px_10px_rgb(0,0,0,0.04)] border-0"
                    >
                        ...
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {doc.aiGenerated && (
                              <Badge
                                variant="outline"
                                className="bg-purple-500/10 text-purple-500 border-0 text-xs rounded-full"
                              >
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          {doc.tags.slice(0, 2).map((tag) => (
                            <Badge
                              key={tag}
                              variant="outline"
                              className="text-xs border-0 bg-muted rounded-full"
                            >
                              {tag}
                            </Badge>
                          ))}
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div
                          className={`h-10 w-10 rounded-lg bg-gradient-to-br ${colorClass} flex items-center justify-center shrink-0`}
                        >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            {doc.aiGenerated && (
                              <Badge
                                variant="outline"
                                className="bg-purple-500/10 text-purple-500 border-0 text-xs rounded-full shrink-0"
                              >
