              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isDown ? 'bg-red-500 dark:bg-red-600' : 'bg-green-500 dark:bg-green-600',
                  )}
                  style={{ height: `${height}%` }}
          ...
          {incidents.length > 0 ? (
            <div className="space-y-4">
              {incidents.map((incident) => (
                <div key={incident.id} className="rounded-lg border border-border bg-card p-6">
                  ...
                  <div className="space-y-3 border-l-2 border-border pl-4 ml-2">
                    {incident.updates.map((update, index) => (
                      <div key={index}>
                        <p className="text-xs text-muted-foreground mb-1">{update.timestamp}</p>
