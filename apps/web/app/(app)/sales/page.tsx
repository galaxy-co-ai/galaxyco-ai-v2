...
import { DollarSign, TrendingUp, Target, Users, Calendar, MapPin, Mail, Phone } from 'lucide-react';
            ...
            {topPerformers.map((performer, index) => (
              <div key={index} className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-success">{performer.winRate}% win rate</p>
                </div>
              </div>
            ))}
          </div>
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <p className="text-xs text-muted-foreground">{deal.closingDate}</p>
              </div>
              <div className="w-20">
