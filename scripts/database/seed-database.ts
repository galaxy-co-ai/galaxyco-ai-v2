...
const SAMPLE_TEMPLATES = [
  {
    ...
    description:
      "Automatically respond to customer emails with intelligent, context-aware replies",
    ...
    config: {
      ...
      maxTokens: 1000,
      systemPrompt:
        "You are a professional email support agent. Write clear, helpful responses.",
  ...
  },
  {
    ...
    description:
      "Automatically score and qualify sales leads based on conversation data",
    ...
    config: {
      ...
      maxTokens: 800,
      systemPrompt:
        "You are a sales qualification expert. Assess leads and provide scores.",
  ...
  },
  {
    ...
    description:
      "Answer questions about uploaded documents using AI-powered search",
    ...
    config: {
      ...
      maxTokens: 1200,
      systemPrompt:
        "You answer questions based on document context. Be accurate and cite sources.",
      tools: ["vector-search"],
      triggers: [{ type: "manual", config: {} }],
    },
    kpis: {
