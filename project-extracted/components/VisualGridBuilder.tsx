...
import { Mail, Calendar, FileText, Database, Zap, Sparkles, Filter, Play, Pause, RotateCcw, Plus, Save, ZoomIn, ZoomOut, Edit3, Plug, MessageSquare, Trash2 } from "lucide-react";
