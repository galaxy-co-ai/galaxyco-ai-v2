...
resource "aws_ecs_task_definition" "api" {
  ...
  container_definitions = jsonencode([
    {
      name      = "api"
      image     = "ghcr.io/galaxy-co-ai/galaxyco-api@sha256:0202abeeb26b561b29f2994bfabc0ddcfb51f6f03ea13fc657c279db433953a2"
      essential = true
      
      repositoryCredentials = {
        credentialsParameter = "arn:aws:secretsmanager:us-east-1:801949251798:secret:galaxyco/prod/ghcr-credentials-At2FN3"
      }
