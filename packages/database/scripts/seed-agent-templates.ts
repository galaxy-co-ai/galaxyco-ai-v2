...
const templates = [
  {
    ...
    description: 'Automates web applications through UI interactions to file forms, reconcile data, and QA flows. Operates like a human user, clicking buttons, filling forms, and extracting data from web pages.',
    ...
    config: {
      ...
      temperature: 0.3,
      maxTokens: 2000,
      systemPrompt: 'You are a browser automation agent. Analyze web pages and execute precise UI interactions based on user instructions.',
  ...
  },
  {
    ...
    description: 'Answers questions with citations from connected knowledge sources. Uses retrieval-augmented generation to provide accurate, sourced responses with source tiles showing where information came from.',
    ...
    config: {
      ...
      temperature: 0.5,
      maxTokens: 3000,
      systemPrompt: 'You are a knowledge retrieval agent. Answer questions accurately using only information from provided sources. Always cite your sources.',
  ...
  },
  {
    ...
    description: 'Comprehensive sales operations agent handling prospecting, enrichment, CRM updates, and sequence personalization. Automates the entire sales workflow from lead discovery to follow-up.',
    ...
    config: {
      ...
      temperature: 0.7,
      maxTokens: 4000,
      systemPrompt: 'You are a sales operations copilot. Help with lead research, personalized outreach, and CRM management.',
  ...
  },
  {
    ...
    description: 'Transcribes meetings, assigns tasks, and schedules follow-ups automatically. Integrates with calendars and project management tools to ensure nothing falls through the cracks.',
    ...
    config: {
      ...
      temperature: 0.4,
      maxTokens: 3500,
      systemPrompt: 'You are a meeting notes orchestrator. Extract action items, decisions, and key points from meeting transcripts.',
  ...
  },
  {
    ...
    description: 'Executes multi-app requests in one prompt. Coordinates actions across calendar, email, docs, and other tools to complete complex workflows with a single command.',
    ...
    config: {
      ...
      temperature: 0.6,
      maxTokens: 3000,
      systemPrompt: 'You are a cross-app automation agent. Break down complex requests into multi-step workflows across different applications.',
  ...
  },
  {
    ...
    description: 'Synthesizes web and internal sources to produce comprehensive briefs with citations. Perfect for market research, competitive analysis, and due diligence.',
    ...
    config: {
      ...
      temperature: 0.5,
      maxTokens: 4000,
      systemPrompt: 'You are a research agent. Gather information from multiple sources and synthesize comprehensive reports.',
  ...
  },
  {
    ...
    description: 'Refactors code, writes tests, reviews PRs, and works with SQL/Notebooks. A full-stack development companion that understands your codebase.',
    ...
    config: {
      ...
      temperature: 0.3,
      maxTokens: 4000,
      systemPrompt: 'You are a code assistant. Help with code review, refactoring, test generation, and SQL queries.',
  ...
  },
  {
    ...
    description: 'Monitors pages, extracts structured data, and pushes to Sheets/DB. Perfect for competitive intelligence, price monitoring, and lead generation.',
    ...
    config: {
      ...
      temperature: 0.2,
      maxTokens: 2500,
      systemPrompt: 'You are a data extraction agent. Extract structured information from web pages and documents.',
  ...
  },
  {
    ...
    description: 'Runs static checks on agents to show security grade and remediation steps. Ensures your AI agents follow best practices and security guidelines.',
    ...
    config: {
      ...
      temperature: 0.3,
      maxTokens: 3000,
      systemPrompt: 'You are a security auditor. Analyze agent configurations for security vulnerabilities and best practices.',
  ...
  },
  {
    ...
    description: 'Computes Trending/Top leaderboards for Agents/Packs based on install velocity, ratings, and engagement metrics.',
    ...
    config: {
      ...
      temperature: 0.1,
      maxTokens: 2000,
      systemPrompt: 'You are a trending analytics agent. Calculate trending scores and rankings based on metrics.',
...
async function seedTemplates() {
  try {
    ...
    inserted.forEach((template, i) => {
      ...
      console.log(`     - Rating: ${(template.rating! / 100).toFixed(2)}⭐ (${template.reviewCount} reviews)`);
