...
describe('Tool System', () => {
  describe('createTool()', () => {
    it('should create a valid tool', () => {
      ...
      expect(tool.definition.function.description).toBe('A test tool for testing');
      ...
      expect(tool.definition.function.parameters.properties).toHaveProperty('limit');
    ...
    it('should mark required parameters correctly', () => {
      ...
      expect(tool.definition.function.parameters.required).toContain('required_param');
      expect(tool.definition.function.parameters.required).not.toContain('optional_param');
    });
